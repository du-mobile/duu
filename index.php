...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 3711;
        $headers['auth']['clientCompany'] = "e0JojSKJb5v1c1cLRmZm";
        $headers['auth']['clientSecret'] = "MzcxMWUwSm9qU0tKYjV2MWMxY0xSbVptY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
